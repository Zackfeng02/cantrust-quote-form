...
-- ALTER TABLE tasks ADD COLUMN IF NOT EXISTS workflow_step   TEXT;
-- ALTER TABLE tasks DROP CONSTRAINT IF EXISTS tasks_workflow_step_check;
-- ALTER TABLE tasks ADD CONSTRAINT tasks_workflow_step_check CHECK (
--   workflow_step IN ('cancel_old_policy', 'cancel_policy', 'new_policy_sign', 'new_policy_entry', 'confirm_app_install')
--   OR workflow_step IS NULL
-- );
